...
That's it! Your class is now a resource. In order to learn what does it mean, please refer to `SyliusResourceBundle <http://docs.sylius.org/en/latest/bundles/SyliusResourceBundle.html>`_ documentation.
